...
namespace
{
    ...
    public:
            ...
            void* progressContext)
        {
            ...
            directIo_ =
                (flags & CLIPPORT_NATIVE_COPY_FLAG_DIRECT_IO) != 0 &&
    ...
    private:
        ...
        ClipPortNativeCopyProgressCallback progressCallback_ = nullptr;
        void* progressContext_ = nullptr;
    };
}
extern "C"
{
    DWORD __stdcall ClipPort_NativeCopyGetApiVersion()
    {
        return CLIPPORT_NATIVE_COPY_API_VERSION;
    }

    void* __stdcall ClipPort_NativeCopyCreate()
    {
    ...
    void __stdcall ClipPort_NativeCopyCancel(void* operation)
    {
        if (operation)
        {
    ...
    void __stdcall ClipPort_NativeCopyDestroy(void* operation)
    {
        delete static_cast<NativeCopyOperation*>(operation);
    }

    DWORD __stdcall ClipPort_NativeCopyFileW(
        void* operation,
        const wchar_t* sourcePath,
        const wchar_t* destinationPath,
        DWORD flags,
