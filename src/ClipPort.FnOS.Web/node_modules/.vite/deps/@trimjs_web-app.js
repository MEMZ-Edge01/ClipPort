    ...
    return new Promise((r2, i2) => {
      null == e2 || e2.callHandler("openFolder", JSON.stringify(t2)).then((e3) => {
        if (n.log("pickFilePromise callback registered", { reqId: e3, params: t2 }), e3) {
          ...
          d.set(e3, o2);
        } else i2(new Error("openFolder failed"));
      });
    });
...
var j = (e2, t2) => {
  ...
  return void 0 !== e2 && (r2 = window.setTimeout(() => {
    let r3 = Error(`Connection timed out after ${e2}ms`);
...
function ke(e2) {
  const t2 = new Error(`NotSupportedInExtensionHost: ${e2}`);
  ...
  return window.addEventListener("message", o2), { request: (e3, t3, i3) => s(function* () {
    const o3 = (function(e4, t4) {
      ...
      "number" == typeof a3 && a3 >= 0 && (l3 = setTimeout(() => {
        n2.delete(o3.requestId), s3(new Error(`Extension host timeout while calling ${e3}`));
    ...
    window.removeEventListener("message", o2), n2.forEach((e3) => {
      clearTimeout(e3.timeoutId), e3.reject(new Error("Extension bridge destroyed"));
    }), n2.clear(), i2.clear();
  } };
}
function qe() {
        ...
        return (function(e3, t3, r3) {
          return v(), new f((n3) => {
            ...
            return c(e3, "wsQuery", null == t3 ? void 0 : t3.req, JSON.stringify(t3), void 0 === r3 ? void 0 : JSON.stringify(r3)).then((e4) => {
              (null == e4 ? void 0 : e4.reqId) ? (i2 = e4.reqId, o2 || h.set(i2, n3)) : n3.error(new Error("Failed to start observable query"));
            }, (e4) => {
              n3.error(e4);
            }), () => {
...
//# sourceMappingURL=@trimjs_web-app.js.map
