...
exports.useBaseIconState = void 0;
 ...
 */
const useBaseIconState = (props, options) => {
    const { 
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    idPrefix, title, primaryFill = 'currentColor', ...rest } = props;
    const state = {
        ...rest,
        fill: primaryFill,
    };
    const iconContext = contexts_1.useIconContext();
    const isRtlFlip = Boolean((options === null || options === void 0 ? void 0 : options.flipInRtl) && (iconContext === null || iconContext === void 0 ? void 0 : iconContext.textDirection) === 'rtl');
    if (title) {
    ...
    state[constants_1.DATA_FUI_ICON] = '';
    return { state, isRtlFlip };
};
exports.useBaseIconState = useBaseIconState;
