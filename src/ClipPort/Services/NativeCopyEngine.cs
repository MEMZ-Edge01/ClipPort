...
{
    private const string LibraryName = "ClipPort.NativeCopy.dll";
        ...
        try
        {
            ...
            try
            {
                nint export = NativeLibrary.GetExport(
                    library,
                    "ClipPort_NativeCopyGetApiVersion");
                var getApiVersion =
    ...
    [DllImport(
        LibraryName,
        EntryPoint = "ClipPort_NativeCopyCreate",
        ExactSpelling = true,
    ...
    [DllImport(
        LibraryName,
        EntryPoint = "ClipPort_NativeCopyCancel",
        ExactSpelling = true,
        CallingConvention = CallingConvention.StdCall)]
    ...
    [DllImport(
        LibraryName,
        EntryPoint = "ClipPort_NativeCopyDestroy",
        ExactSpelling = true,
        CallingConvention = CallingConvention.StdCall)]
    ...
    [DllImport(
        LibraryName,
        EntryPoint = "ClipPort_NativeCopyFileW",
        ExactSpelling = true,
        CallingConvention = CallingConvention.StdCall,
